...
<div align="center">
  ...
  <p>
    ...
    <a href="CONTRIBUTING.md">
      <img src="https://img.shields.io/badge/contributions-welcome-111827" alt="Contributions welcome" />
    </a>
  </p>
</div>
...
![VercelZero README demo](./assets/vercelzero-readme-demo.gif)
...
flowchart LR
    ...
    B --> D[Preview Layer]
    B --> E[AI-Assisted Flow]
    C --> F[Feedback States]
    D --> F
    E --> F
    F --> G[Portfolio-grade Product Experience]
```
...
```mermaid
graph TD
    A[Now: Product-grade README + Demo UX] --> B[Next: Richer deployment timeline]
    B --> C[Next: AI-assisted deployment actions]
    C --> D[Next: Stronger automated testing]
    D --> E[Next: Architecture and case-study docs]
    E --> F[Next: Better accessibility + mobile polish]
    F --> G[Next: Faster contributor onboarding]
```
